namespace VTSMASTER.Server.Services.ProductService
{
    public class ProductService : IProductService
    {
		...
		public async Task<ServiceResponse<Product>> GetProductAsync(int productId)
		{
            ...
            if(product == null)
            {
                ...
                response.Message = "zao nam je sto ovo sto vi trazite nepostoji";
            }
            else
            {
        ...
        {
            var dbProduct = await _context.Products.Include(p => p.Image).FirstOrDefaultAsync(p => p.Id == product.Id);
            if (dbProduct == null)
            {
            ...
            var productImages = dbProduct.Image;
